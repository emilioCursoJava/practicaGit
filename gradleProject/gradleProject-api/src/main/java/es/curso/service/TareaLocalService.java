...
public interface TareaLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TareaLocalServiceUtil} to access the tarea local service. Add custom service methods to {@link es.curso.service.impl.TareaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Tarea> getTareasByUuidAndCompanyId(String uuid, long companyId);
