...
import es.curso.service.TareaLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.curso.service.impl.TareaLocalServiceImpl}.
 * </p>
 *
...
public abstract class TareaLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link es.curso.service.TareaLocalServiceUtil} to access the tarea local service.
	 */
	...
	public List<Tarea> getTareasByUuidAndCompanyId(String uuid, long companyId,
		...
		return tareaPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("es.curso.model.Tarea",
			tareaLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("es.curso.model.Tarea");
	}
